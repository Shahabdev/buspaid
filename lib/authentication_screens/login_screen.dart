    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: SingleChildScrollView(
            child: Column(
              children: [
                Image.asset("assets/logo.png",height:  screenWidth * 0.45,),
                ...
                Padding(
                  padding: EdgeInsets.only(left: 24.0, top: 20.h),
                  child: Row(
                    children: [
                      Padding(
                ...
                const CustomTextField(
                  prefixIcon: Icon(Icons.email_outlined,color: Color(0xffb5b7ba),),
                ...
                const CustomTextField(
                  prefixIcon: Icon(Icons.lock_outline_rounded,color: Color(0xffb5b7ba),),
                  hintText: "Password",
        ...
        decoration: InputDecoration(
          ...
          suffixIcon: widget.showVisibilityToggle && widget.obscureText
            ...
            icon: Icon(
              ...
              color: const Color(0xffb5b7ba), // Optional: change color
            ),
